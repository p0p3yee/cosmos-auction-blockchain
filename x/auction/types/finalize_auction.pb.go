...
type FinalizeAuction struct {
	...
	FinalPrice string `protobuf:"bytes,5,opt,name=finalPrice,proto3" json:"finalPrice,omitempty"`
...
func (m *FinalizeAuction) GetFinalPrice() string {
	if m != nil {
		return m.FinalPrice
	}
	return ""
...
var fileDescriptor_7a04c5586b41bb2a = []byte{
	...
	,
}
...
func (m *FinalizeAuction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Winner) > 0 {
		...
		i = encodeVarintFinalizeAuction(dAtA, i, uint64(len(m.Winner)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.FinalPrice) > 0 {
		...
		i = encodeVarintFinalizeAuction(dAtA, i, uint64(len(m.FinalPrice)))
		i--
		dAtA[i] = 0x2a
	}
	if m.BidId != 0 {
